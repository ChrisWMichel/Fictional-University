        ...
        <div class="full-width-split__inner">
          ...
          <?php
            ...
            while($homepagePosts->have_posts()) {
                ...
                <div class="event-summary" style="border-bottom: 1px solid #dedede;">
                    ...
                    <p><a class="gray nu" style="background-color: transparent;" href="<?php the_permalink(); ?>">Continue reading &raquo;</a></p>
                </div>
            <?php } wp_reset_postdata();
          ?>
